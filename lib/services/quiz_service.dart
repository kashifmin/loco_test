...
var questions = [
  new Question("Question 1", ["Choice 1", "Choice 2"], 2),
  new Question(
      ...
      1),
  new Question(
      "Question 3: This question will span multiple and probably "
      " occupy more space than any other questions",
...
class QuizService {
  ...
  Observable<Question> getQuestions() {
    ...
    var quizes = new Observable.periodic(new Duration(seconds: 10), ([int i]) {
